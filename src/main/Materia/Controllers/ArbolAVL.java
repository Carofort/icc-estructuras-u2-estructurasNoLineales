...
public class ArbolAVL {
    ...
    private Node insert(Node nodo, int value) {
        ...
        if(nodo == null){
            ...
            newNode.setHeight(1);
            System.out.println("Nodo insertado: " + value + ", Balance: " + getBalance(nodo));
            return newNode;
        }
        ...
        System.out.println("\tEquilibrio del nodo: " + nodo.getValue() + " es: " + getBalance(nodo));
